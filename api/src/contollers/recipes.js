...
const getApiRecipes = async() =>{
    ...
    const apiInfo = await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=27b1d7c4e73a4fe3a4a5170948108d76&addRecipeInformation=true&number=100`)
